...
windows.metrics.windowActivated = function (that) {
    ...
    if (hwnd !== state.activeWindow) {
        ...
        if (hwnd) {
            ...
            if (activePid) {
                exePath = windows.metrics.getProcessPath(activePid);
            }
        }
 ...
 */
windows.metrics.getProcessPath = function (pid, processHandle) {
    var hProcess;
    var togo = null;
    var ref = require("ref");
...
windows.metrics.startInputMetrics = function (that) {
    ...
    } else if (true || process.versions.electron) {
